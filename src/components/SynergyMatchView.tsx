...
export const SynergyMatchView: React.FC<SynergyMatchViewProps> = ({
  ...
  return (
    <div className="max-w-7xl mx-auto px-6 py-8 animate-in fade-in duration-300">
      ...
      <button
        onClick={onBack}
        className="mb-6 flex items-center gap-1.5 text-xs font-semibold text-stone-500 hover:text-stone-900 transition-colors"
      ...
      <div className="mb-8 text-center max-w-3xl mx-auto">
        ...
        <p className="mt-2 text-sm text-stone-500 leading-relaxed max-w-2xl mx-auto">
      ...
      <div className="bg-white border border-stone-200/80 rounded-2xl p-8 mb-8 shadow-xs">
